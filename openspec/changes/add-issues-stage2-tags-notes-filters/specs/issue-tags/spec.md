...
The system SHALL allow admins to add one or more free-text tags to an issue via a text array field, and SHALL display tags as colored badges on issue cards.
...
- **AND** the tags SHALL be displayed as colored badges on the issue card
...
- **THEN** no tag badges SHALL be displayed on the issue card
