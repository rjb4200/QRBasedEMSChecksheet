## Purpose
Define manual restock items that crews can add to the Restocking List independently of checkoff-generated exceptions, with addressed checkboxes and cross-device polling.
