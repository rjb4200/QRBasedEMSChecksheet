...
<div className="grid gap-4">
          <form action={assignKitToUnit} className="grid gap-3 rounded-3xl bg-white p-4 shadow-sm md:grid-cols-[minmax(0,1fr)_130px]">
            <input name="unitId" type="hidden" value={id} />
            ...
            <input className="rounded-2xl border border-slate-300 px-4 py-3" name="sortOrder" placeholder="Order" type="number" />
            <button className="rounded-2xl bg-red-700 px-5 py-3 font-bold text-white md:col-span-2" type="submit">Assign Kit</button>
          </form>

          <form action={cloneKitToUnitCompartment} className="grid gap-3 rounded-3xl bg-white p-4 shadow-sm md:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
            <input name="unitId" type="hidden" value={id} />
            <select className="rounded-2xl border border-slate-300 px-4 py-3" name="kitId" required>
