  ...
  return (
    <main className="min-h-screen bg-slate-100 px-5 py-8 text-slate-950 animate-pulse">
      <section className="mx-auto max-w-7xl space-y-6">
        ...
        <div className="rounded-3xl bg-white p-4 shadow-sm grid sm:grid-cols-[1fr_220px_auto_auto] gap-4">
        ...
        <div className="rounded-3xl bg-white p-4 shadow-sm grid md:grid-cols-[1fr_180px_160px_140px_auto] gap-4">
          <div className="col-span-full h-4 w-20 rounded bg-slate-200" />
          <div className="h-10 rounded-2xl bg-slate-100" />
          <div className="h-10 rounded-2xl bg-slate-100" />
          <div className="h-10 rounded-2xl bg-slate-100" />
