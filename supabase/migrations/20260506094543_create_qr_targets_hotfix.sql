-- Matches the remote hotfix applied after the CLI marked 20260506090000 as applied
-- without creating public.qr_targets. Statements are idempotent so local/remote
-- migration history can stay aligned.
